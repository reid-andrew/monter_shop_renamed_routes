...
describe Item, type: :model do
  ...
  describe "instance methods: " do
    ...
    it "item#average_review" do
      expect(@chain.average_review).to eq(3.0)
    end

    it "item#sorted_reviews" do
